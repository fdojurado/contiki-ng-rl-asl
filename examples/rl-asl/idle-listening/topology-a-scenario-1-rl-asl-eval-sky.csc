...
<simconf>
  <simulation>
    ...
    <motetype>
      ...
      <description>RPL/TSCH Node</description>
      <source>[CONTIKI_DIR]/examples/rl-asl/idle-listening/idle-listening.c</source>
      <commands>$(MAKE) -j$(CPUS) TARGET=sky idle-listening.sky MAKE_WITH_RL_ASL=1 MAKE_WITH_RL_ASL_TRAIN=0 MAKE_WITH_RL_ASL_MODEL=results/topology-a RELAY=1
    ...
    <motetype>
      ...
      <description>RPL/TSCH Node</description>
      <source>[CONTIKI_DIR]/examples/rl-asl/idle-listening/idle-listening.c</source>
      <commands>$(MAKE) -j$(CPUS) TARGET=sky idle-listening.sky MAKE_WITH_TRAFFIC_PATTERN=1 MAKE_WITH_RL_ASL=1 MAKE_WITH_RL_ASL_TRAIN=0 MAKE_WITH_RL_ASL_MODEL=results/topology-a LEAF=1
