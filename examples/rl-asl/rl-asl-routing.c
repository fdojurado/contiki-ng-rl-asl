...
const routing_entry_t routing_table[] = {
    ...
    {{{0x07, 0x00}}, {{0x01, 0x00}}, {{0x02, 0x00}}},
    {{{0x08, 0x00}}, {{0x01, 0x00}}, {{0x03, 0x00}}},
    {{{0x09, 0x00}}, {{0x01, 0x00}}, {{0x03, 0x00}}},
    {{{0xa, 0x00}}, {{0x01, 0x00}}, {{0x03, 0x00}}},
    {{{0xb, 0x00}}, {{0x01, 0x00}}, {{0x04, 0x00}}},
    {{{0xc, 0x00}}, {{0x01, 0x00}}, {{0x04, 0x00}}},
    {{{0xd, 0x00}}, {{0x01, 0x00}}, {{0x04, 0x00}}},
    {{{0x00, 0x00}}, {{0x00, 0x00}}, {{0x00, 0x00}}} // End marker
};
