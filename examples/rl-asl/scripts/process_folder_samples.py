...
def process_folder_samples(folder: Path, results: Mapping[str, Mapping[str, Any]], output_file: Path | None = None) -> None:
    ...
    net_avg_cpu_power: List[float] = []   # "avg_cpu_mW" across runs
    ...
    net_avg_rx_non_uc_total_power: List[float] = []   # "avg_mW" across runs
    ...
    for run_id, run in results.items():
        ...
        if "avg_cpu_mW" in power:
            net_avg_cpu_power.append(float(power["avg_cpu_mW"]))
        ...
        if "avg_rx_non_uc_total_mW" in power:
            net_avg_rx_non_uc_total_power.append(
                float(power["avg_rx_non_uc_total_mW"]))
    ...
    net_summary["power"]["avg_cpu_mW"] = 0.0
    net_summary["power"]["std_cpu_mW"] = 0.0
    if net_avg_cpu_power:
        mu, su = safe_mean_std(net_avg_cpu_power)
        net_summary["power"]["avg_cpu_mW"] = mu
        net_summary["power"]["std_cpu_mW"] = su
    ...
    net_summary["power"]["avg_rx_non_uc_total_mW"] = 0.0
    net_summary["power"]["std_rx_non_uc_total_mW"] = 0.0
    if net_avg_rx_non_uc_total_power:
        mu, su = safe_mean_std(net_avg_rx_non_uc_total_power)
        net_summary["power"]["avg_rx_non_uc_total_mW"] = mu
        net_summary["power"]["std_rx_non_uc_total_mW"] = su
